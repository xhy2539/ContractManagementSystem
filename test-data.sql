...
INSERT INTO contracts (
    ...
    100000.00, 
    '分期付款',
    '本合同是关于软件开发服务的合同。甲方委托乙方开发一套合同管理系统。合同期限为一年，总金额为10万元。支付方式为分期付款。违约责任条款：如一方违约，需承担连带责任。争议解决：双方如有争议，应友好协商解决。保密条款：双方应对商业机密严格保密。知识产权归甲方所有。不可抗力条款已包含。付款方式为银行转账。交付条件为验收合格后交付。验收标准按照需求文档执行。适用中华人民共和国法律。',
